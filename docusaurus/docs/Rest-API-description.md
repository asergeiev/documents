...
The most popular case of subject usage is to assign a subject to one
...
find a person on the image.

Another case of subject usage is assigning a photo of several people as
...
When you save a subject example, CompreFace calculates the embedding of
